...
public class OrderWide {
    ...
    public void calcUserAge(String birthday) {
        // 使用今天的毫秒-生日的毫秒值
        long today = System.currentTimeMillis();
        try {
            long birth = new SimpleDateFormat("yyyy-MM-dd").parse(birthday).getTime();
            this.setUser_age((int) ((today - birth) / 1000 / 60 / 60 / 24 / 365));
